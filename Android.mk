...
ifneq ($(OF_CUSTOM_PASS_PARTITION),)
    LOCAL_CFLAGS += -DOF_CUSTOM_PASS_PARTITION='"$(OF_CUSTOM_PASS_PARTITION)"'
endif

ifneq ($(OF_CUSTOM_PASS_MOUNT),1)
    LOCAL_CFLAGS += -DOF_CUSTOM_PASS_MOUNT='"1"'
endif
